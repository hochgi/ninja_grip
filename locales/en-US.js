...
window.NINJA_LOCALES['en-US'] = {
  ...
  "menu": {
    ...
    "title": "Ninja Grip",
    "hint": "On phone: Play opens landscape fullscreen. Tap anywhere to aim+fire. Swipe up (or Jump) to detach. Tilt to swing / rope.",
    "play": "Play ▶",
    "skins": "Skins",
    "help": "How to play"
  },
  ...
  "skins": {
    ...
    "title": "Skins",
    "progress": "{{owned}} / {{total}} owned  •  🪙 {{coins}} coins",
    "selected": "✓ Selected",
    "select": "Tap to select",
    "back": "Back"
  },
  "skinsNames": {
    "classic": "Classic Ninja",
    "crimson": "Crimson Blade",
    "jade": "Jade Green",
    "azure": "Night Azure",
    "gold": "Golden Master",
    "violet": "Violet Shadow",
    "storm": "Iron Storm",
    "sakura": "Sakura Bloom",
    "venom": "Venom Ninja",
    "obsidian": "Obsidian",
  ...
  "battle": {
    ...
    "winSub": "Victory!",
    "loseSub": "Defeat",
    "winMsg": "You earned 🪙 {{reward}} coins!",
    "loseMsg": "Try again — earn coins in the main run.",
    "back": "Back to game",
    "next": "Next stage"
  },
  "hideSeek": {
    "subtitle": "Find them all before time runs out",
    "title": "Ninja Hide & Seek",
    "instructions": "You are the <b>seeker</b> — find 9 hiding ninjas.<br><b>D-pad</b> to move • <b>🔫</b> to shoot<br>Hit a ninja = found!<br>You have <b>60 seconds</b> and <b>12 bullets</b>.",
    "start": "Start searching! 🔍",
    "result": "Result",
    "found": "Ninjas found",
    "winSub": "🏆 You found them all!",
    "loseSub": "⏱ Time's up",
    "winMsg": "All ninjas found!",
    "loseMsg": "Ninjas found",
    "again": "Play again"
  }
};
